...
namespace CarRentalApi._2_Modules.Bookings._3_Domain.Errors;
...
public static class ReservationErrors {
   ...
   public static readonly DomainErrors NoCarCategoryCapacity =
      new(
         ErrorCode.Conflict,
         Title: "No Car CarCategory Capacity",
         Message: "No Cars Are Available In The Selected CarCategory For The Given Period."
      );
}
